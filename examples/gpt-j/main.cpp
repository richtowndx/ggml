        ...
        // self-attention
        {
            ...
            struct ggml_tensor * V =
                ggml_view_3d(ctx0, model.memory_v,
                        ...
                        n_ctx*ggml_element_size(model.memory_v),  // ggml_element_size
                        n_ctx*ggml_element_size(model.memory_v)*n_embd/n_head,  // ggml_element_size
